...
export function BentoTile({
  ...
  return (
    <motion.button
      ...
      className={`group relative flex min-w-0 flex-col gap-3 overflow-hidden rounded-lg border border-border bg-surface/80 p-5 text-left shadow-rest backdrop-blur-sm transition-shadow hover:shadow-hover ${className ?? ""}`}
    >
